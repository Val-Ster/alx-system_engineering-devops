...
This project includes Python scripts to interact with a REST API, gather data, and export it in various formats.

## Scripts

1. `0-gather_data_from_an_API.py`: Displays the TODO list progress of a given employee.
2. `1-export_to_CSV.py`: Exports the TODO list of a given employee to a CSV file.
3. `2-export_to_JSON.py`: Exports the TODO list of a given employee to a JSON file.
4. `3-dictionary_of_list_of_dictionaries.py`: Exports the TODO lists of all employees to a single JSON file.

## Usage

Make sure to give execute permission to the scripts:
```bash
